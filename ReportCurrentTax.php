...
class PDF extends FPDF {
    function Header(){
        ...
        $this->Cell(70,5,'',0,0);
        $this->Cell(91,5,'Current Tax Report',0,0);
        $this->Cell(52,5,'',0,1);
        ...
        $this->Cell(35,5,'Bussiness Code',1,0,'',true);


        $this->Cell(30,5,'Name',1,0,'',true);
        $this->Cell(25,5,'Tax Amount',1,0,'',true);
        $this->Cell(25,5,'Current Tax',1,0,'',true);
        $this->Cell(25,5,'Penality',1,0,'',true);
        $this->Cell(35,5,'Date last Tax Paid',1,0,'',true);
...
$busssinessCode=$_REQUEST['bussinessCode'];
...
$pdf->Cell(35,5,$busssinessCode,1,0);

$pdf->Cell(30,5,$taxAmount,1,0);

$pdf->Cell(25,5,$currentTax,1,0);
$pdf->Cell(25,5,$datelastpaid,1,0);

$pdf->Cell(25,5,$penality,1,0);
