...
<div class="panelDisplay">
    ...
    <form   action="<?php   ?>" method="POST"    class="divforms"   enctype="multipart/form-data" name="countyForms" id="countyForm">
        ...
        <div class="form-group">
            ...
            <input type="text" name="bussinessCode" id="$BussinessCodes" value="<?php echo $BussinessCodes?>"  onkeyup="formVal_numbers_keyup(this)" />
        </div>

        <div class="form-group">

            <label for="bussinessName">Bussiness Name</label>
            <input type="text" name="bussinessName" id="bussinessName"  value="<?php echo $BussinessNames?>" onkeyup="countyForm_keyup(this)" />
        </div>
        <div class="form-group">

            <label for="date">Date</label>
            <input type="date" name="dates"  class="form-control"  size="30"  value="<?php echo $Datess?>" placeholder="YYYY/MM/DD" id="date" />
        </div>
