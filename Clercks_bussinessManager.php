...
<div class="panelDisplay">
    ...
    <form   action="<?php   ?>" method="POST"    class="clercksbussinessmanager"   enctype="multipart/form-data" name="countyForms" id="countyForm">

        <div class="form-group">
            <label for="bussinessCode">Bussiness Number</label>
            <input type="text" name="bussinessCode" id="BussinessCodes"  maxlength="30" value="<?php echo $BussinessCodes?>"  onkeyup="formVal_numbers_keyup(this)" />
        </div>

        <div class="form-group">

            <label for="bussinessName">Bussiness Name</label>
            <input type="text" name="bussinessName" id="bussinessName"  maxlength="30" value="<?php echo $BussinessNames?>" onkeyup="countyForm_keyup(this)" />
        </div>
        <div class="form-group">

            <label for="date">Date</label>
            <input type="date" name="dates"  id="dateentry" class="form-control" min="2009-05-11" size="30"  value="<?php echo $Datess?>" placeholder="YYYY/MM/DD" id="date" />
        ...
        <textarea class="form-control" name="description"  maxlength="80"  id="description" >
        ...
        <br />
        <input name="save" type="submit"   class="btn btn-primary  " value="Save" id="savebutton" onclick="return bussiness_Manager()"  />
        <input name="update" type="submit" class="btn btn-primary  " value="Update"  />
        <input name="search" type="submit" class="btn btn-primary " value="Search" onclick=" return bussiness_managerSearch()" />
...
<script>
    ...
    function bussiness_Manager()
    {
        var bussinesscodes = document.getElementById('BussinessCodes').value;
        ...
        var  subCountyCode=document.getElementById('subCountyCodes').value;
        var  districts=document.getElementById('district').value;
        var  locationname=document.getElementById('LocationName').value;
        var  towns=document.getElementById('town').value;
        var bussnesstype=document.getElementById('bussinessType').value;
        var descriptions=document.getElementById('description').value;



        if(bussinesscodes=="" ||bussinessname=="" ||dateentry=="" ||countyCodes==""||subCountyCode==""||districts==""||locationname==""||towns==""||descriptions=="" )
        {
    ...
    function bussiness_managerSearch()
    {
        var bussinesscodes = document.getElementById('BussinessCodes').value;

        if((bussinesscodes=="")
        {
            alert('Please fill in the Bussiness Code');
            return false;
