...
<div class="paneldisplaylogins">
    ...
    <form action="<?php   ?>" method="POST"    class="clercksadminlogindetails"  enctype="multipart/form-data" name="usersBussLogin" id=""  >
        ...
        <div class="form-group">
            ...
            <input type="text" name="IdNumber" placeholder="Enter User  Number" id="IdNumber" value="<?php echo $start?>" readonly maxlength="15" onkeyup="formVal_numbers_keyup(this)"  autofocus required/>
        </div>
        <div class="form-group">
            <label for="userName"> Username</label>
            <input type="text" name="userName" placeholder="Enter User Name" value="<?php echo $username?>" id="userName"  />
        </div>
        <div class="form-group">
            <label for="Passwords"> Password</label>
            <input type="password" name="Passwords" placeholder="*******" value="<?php echo $password?>" id="password"  />
        </div>
        ...
        <input name="update" type="submit"   class="btn btn-primary  " value="Save edited Data" id="edited"  onclick="return clercksadminlogin()" />
...
<script>
    function clercksadminlogin()
    {
        var cleckuserid = document.getElementById('IdNumber').value;
        var clecrcksusername= document.getElementById('userName').value;
        var passwds= document.getElementById('password').value;
        var emails=document.getElementById('eEmails').value;
